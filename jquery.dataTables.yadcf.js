...
var yadcf = (function ($) {
    ...
    function addRangeNumberToFilter(filter_selector_string, table_selector_jq_friendly, column_number, filter_reset_button_text, filter_default_label, ignore_char) {
        var fromId = "yadcf-filter-" + table_selector_jq_friendly + "-from-" + column_number,
            toId = "yadcf-filter-" + table_selector_jq_friendly + "-to-" + column_number,
            filter_selector_string_tmp,
            filter_wrapper_id,
        ...
        $(filter_selector_string).append("<input hidden placeholder=\"" + filter_default_label + "\" id=\"" + fromId + "\" value=\"0\" class=\"yadcf-filter-range-number yadcf-filter-range\" " + filterActionStr + "></input>");
            ...
            if (args.hasOwnProperty(columnObjKey)) {
                ...
                if ($filter_selector.length === 1) {
                    ...
                    if (columnObj.filter_type === "select" || columnObj.filter_type === 'custom_func') {
                        ...
                        addRangeNumberToFilter(filter_selector_string, table_selector_jq_friendly, column_number, filter_reset_button_text, filter_default_label, ignore_char);
