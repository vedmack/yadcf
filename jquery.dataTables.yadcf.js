...
var yadcf = (function ($) {
    ...
    function addRangeNumberToFilter(filter_selector_string, table_selector_jq_friendly, column_number, filter_reset_button_text, filter_default_label, ignore_char, range_number_from) {
        var fromId = "yadcf-filter-" + table_selector_jq_friendly + "-from-" + column_number,
            toId = "yadcf-filter-" + table_selector_jq_friendly + "-to-" + column_number,
            filter_selector_string_tmp,
            filter_wrapper_id,
        ...
        // hide the fromId input and set its value to 0
        $(filter_selector_string).append("<input hidden placeholder=\"" + filter_default_label + "\" id=\"" + fromId + "\" value=\"" + range_number_from + "\" class=\"yadcf-filter-range-number yadcf-filter-range\" " + filterActionStr + "></input>");

        $(filter_selector_string).append("<input onkeydown=\"yadcf.preventDefaultForEnter(event);\" placeholder=\"" + filter_default_label + "\" id=\"" + toId + "\" class=\"yadcf-filter-range-number yadcf-filter-range\" " + filterActionStr + "></input>");
    ...
    function appendFilters(oTable, args, table_selector, pSettings) {
        ...
        for (columnObjKey in args) {
            if (args.hasOwnProperty(columnObjKey)) {
                ...
                range_number_from = columnObj.range_number_from;
                ...
                if (filter_default_label === undefined) {
                    ...
                    } else if (columnObj.filter_type === "range_number_to") {
                        filter_default_label = placeholderLang.range_to;
                ...
                if ($filter_selector.length === 1) {
                    ...
                    if (columnObj.filter_type === "select" || columnObj.filter_type === 'custom_func') {
                        ...
                        addRangeNumberToFilter(filter_selector_string, table_selector_jq_friendly, column_number, filter_reset_button_text, filter_default_label, ignore_char, range_number_from);
    ...
    function initMultipleTables(tablesArray, filtersOptions) {
        ...
        for (columnsArrIndex = 0; columnsArrIndex < filtersOptions.length; columnsArrIndex++) {
            ...
            if (columnsObj.filter_default_label === undefined) {
                ...
                } else if (columnsObj.filter_type === "range_number_to") {
                    columnsObj.filter_default_label = "up to";
